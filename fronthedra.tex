...
\linhalayout{edição brasileira©}{Hedra \ifdef{\ano}{\ano}{2020}}
...
%logos
\vfill
\ifdef{\logo}{\IfFileExists{\logo}{\hfill\includegraphics[width=3cm]{\logo}\hfill\logoum{}\\ São Paulo\_2020}}{\logoum\break{} São Paulo\quad2020}
